import { SiJavascript, SiTypescript, SiReact, SiNodedotjs, SiExpress, SiMongodb, SiNextdotjs, SiBootstrap,SiTailwindcss, SiCss3, SiHtml5,SiGithub,SiNetlify,SiVercel,SiPostman,SiRender} from 'react-icons/si';
  ...
  return (
    <section className="py-24 bg-linear-to-b from-crypto-blue to-[#12141C] relative overflow-hidden">      
      ...
      <div className="container flex flex-wrap gap-10 mx-auto px-4 relative z-10 py-12">
        <h1 className='w-screen text-center text-3xl md:text-4xl font-bold mb-3 text-gradient'>Tools I use </h1>
        <div className="w-full flex flex-wrap justify-center gap-8 mt-8">
